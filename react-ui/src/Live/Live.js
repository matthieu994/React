...
const DEV = false;
const SPRITE =
	"https://vignette.wikia.nocookie.net/theunitedorganizationtoonsheroes/images/4/48/Yoshi.png/revision/latest?cb=20160502152521";
...
class Image extends Component {
	render() {
		...
		return <img style={style} src={SPRITE} alt="character" />;
	}
}
